...
const AdminControl = () => {
    ...
    return (
        <div style={{backgroundColor:'#89CFF0', height:'650px'}}>
            <Navbar />
            <>
                <center><h1>Admin Dashboard</h1></center>
                <center><button onClick={newData} className="m-2 p-2 btn btn-warning">{addData ? 'Hide' : 'Add New Users'}</button></center>
                <center>
                ...
                {addData ? <AddDataComp heading="Add New Users" button="Add" /> : null}
                <center> <button onClick={showAllData} className="btn btn-danger m-2 p-2">All Users</button></center>
                <select
